...
export const takeOrder = async (order) => {
  try {
    const response = await axios.post(
      "http://localhost:5000/api/v1/orders/new",
      order,
      { withCredentials: true }
    );
    return response.data || response;
...
export const changeRole = async (id, data) => {
  try {
    const response = await axios.put(
      `http://localhost:5000/api/v1/admin/user-role/${id}`,
      data,
      { withCredentials: true }
    );
...
export const addSlider = async (data) => {
  try {
    const response = await axios.post(
      "http://localhost:5000/api/v1/admin/slider",
      data,
      { withCredentials: true }
    );
    return response.data;
...
export const addTestimonial = async (data) => {
  try {
    const response = await axios.post(
      "http://localhost:5000/api/v1/admin/testimonal",
      data,
      { withCredentials: true }
    );
    return response.data;
...
export const addBanner = async (data) => {
  try {
    const response = await axios.post(
      "http://localhost:5000/api/v1/admin/banner",
      data,
      { withCredentials: true }
    );
    return response.data;
...
export const deleteBanner = async (id) => {
  try {
    const response = await axios.delete(
      `http://localhost:5000/api/v1/admin/banner/${id}`,
      { withCredentials: true }
    );
    return response.data;
  } catch (error) {
...
export const deleteTestimonial = async (id) => {
  try {
    const response = await axios.delete(
      `http://localhost:5000/api/v1/admin/testimonal/${id}`,
      { withCredentials: true }
    );
    return response.data;
  } catch (error) {
...
export const addCategory = async (data) => {
  try {
    const response = await axios.post(
      "http://localhost:5000/api/v1/admin/category/new",
      data,
      { withCredentials: true }
    );
    return response.data;
...
export const addReview = async (data) => {
  try {
    const response = await axios.put(
      "http://localhost:5000/api/v1/product/add-review",
      data,
      { withCredentials: true }
    );
    return response.data;
...
export const deleteTestimonialUser = async (id) => {
  try {
    const response = await axios.delete(
      `http://localhost:5000/api/v1/user/delete-testimonal/${id}`,
      { withCredentials: true }
    );
    return response.data;
  } catch (error) {
...
export const getSearchedProducts = async (search) => {
  try {
    const response = await axios.get(
      `http://localhost:5000/api/v1/products?keyword=${search}`
    );
    return response;
  } catch (error) {
    return { error: error.message };
...
export const forgetPasswordUser = async (user) => {
  try {
    const response = await axios.post(
      "http://localhost:5000/api/v1/forget-password",
      user
    );
    return response.data;
  } catch (error) {
